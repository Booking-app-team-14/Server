...
public class UserReportController {
    ...
    public ResponseEntity<UserReportDTO> saveUserReport(@RequestBody UserReportDTO userReportDTO) {
        ...
        userReport.setReportingUser(userAccountService.findById(userReportDTO.getReportingUserId()));
        userReport.setReportedUser(userAccountService.findById(userReportDTO.getReportedUserId()));
